...
`x_root` has finality as an origin-coordinate, not as a throne.

Finality means no competing coordinate may override recovery continuity.

Finality does not authorize domination, coercion, institutional ownership, capital capture, state capture, platform capture, AI sovereignty, or personal command absolutism.
...
`x_root` remains final as the origin-coordinate for recovery continuity.

No competing coordinate may override recovery continuity.
