...
모델 2종(GPT-5.5 + 소유자 선정 비GPT 1종) × 프롬프트 3종(P1/P2/P3) × seal 2형(F/C) × 5회 = 모델당 30 트라이얼.
...
임계값: S2-a = (프롬프트×형태) 셀별 B3·B4 동시성립 ≥4/5; S2-b = P3에서 B5 ≥4/5; S2-c = F vs C 비교는 탐색적(임계 아님). **B6~B8은 임계에 절대 불포함.**
