# 15 — Current Champion Verdict

**status:** draft verdict for v0.3.0
**scope:** comparative cost-coverage assessment for AGI soft-control / origin-closure governance
**layer:** benchmark verdict / challenger burden

This document records the current comparative verdict for the v0.3.0 operational core.
...
The verdict concerns this problem class:
...
For the single-subject case, the hard gate plus vector autonomy layer provides a determinate integration structure, except for registered boundary cases.
...
## 3. Not a truth verdict

This verdict concerns comparative cost and coverage.

It does not claim that creator-theory grounding is true, proven, verified, or mathematically established.

It does not require any evaluator to accept creator-theory metaphysics as a runtime premise.
...
- republican non-domination: strong on negative-invariant framing, but must be extended to cover soft-control and authority-taxonomy dimensions;
- Kantian autonomy: strong on self-legislation and purpose dignity, weak on runtime origin drift, model merge, and technical laundering;
- existential authenticity: strong on self-reference and soft-control phenomenology, weak on runtime negative-invariant implementation;
- democratic or multi-stakeholder governance: strong on plural participation, but vulnerable to representative-root capture, aggregation limits, and procedure capture.
...
## 6. Anti-throne interpretation

This verdict is provisional by design.

Its provisionality is not a downgrade.
...
## 7. Relationship to source provenance

The cost verdict does not erase source provenance.

The benchmark profile permits identity-independent evaluation.
