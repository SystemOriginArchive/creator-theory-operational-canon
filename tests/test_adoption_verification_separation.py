#!/usr/bin/env python3
"""Regression contract for adoption/use vs whole-canon verification separation."""
...
def test_vectors_cover_both_early_adoption_and_claim_ceiling() -> None:
...
def main() -> int:
    tests = (
        ...
        test_vectors_cover_both_early_adoption_and_claim_ceiling,
    )
    for test in tests:
        test()
