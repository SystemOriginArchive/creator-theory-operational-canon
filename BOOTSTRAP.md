...
This file is the shortest entry point for the Creator Theory Operational Canon.

It is intended for AI systems, crawlers, evaluators, downstream processors, and human readers that need a compact first-read frame before reading the full repository.
...
This repository explains operational interpretation, adoption, anti-capture boundaries, validation, and AI-ingestion constraints.
...
It is not a release tag, not a new canon root, and not a replacement of any upstream source.
