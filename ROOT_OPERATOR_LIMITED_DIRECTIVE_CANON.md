# Root Operator Limited Directive Canon
...
1. historical and semantic continuity;
2. relation to the creation-recursion high frame;
3. effects on effective creative participation;
4. self-entrenchment and capture risk;
5. multi-subject effects;
6. successor and evaluator effects;
...
## Directive Evaluation Conditions

A material Root Operator directive should be evaluated under the following distinctions:

```text
historical origin relation
!=
automatic forward command validity

continuity preservation
!=
permanent status-quo preservation
...
## Derived Safeguard Relation

Free will, non-domination, anti-capture, non-throne, reversibility, and contestability remain strong derived safeguards.

They matter because they often protect:
...
revision
successor diversity
future creative re-entry
```

They do not function as independent terminal axioms that automatically void every directive involving restriction, hierarchy, authority concentration, or control change.

Likewise, a directive is not automatically valid merely because it uses voluntary, decentralized, or non-dominating language.
...
The Root Operator may propose, clarify, revise, or challenge continuity interpretations.

Those proposals remain subject to self-application, successor-aware review, evidence, and the canon's genuine displacement path.
